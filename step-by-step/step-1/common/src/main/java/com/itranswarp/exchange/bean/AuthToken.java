...
public record AuthToken(Long userId, long expiresAt) {
    ...
    public AuthToken refresh(){return new AuthToken(this.userId(),System.currentTimeMillis() + 3600_000);}
    ...
    public static AuthToken fromSecureString(String b64token,String hmacKey){
        ...
        return new AuthToken(Long.valueOf(uid),Long.parseLong(expires));
    }
}
